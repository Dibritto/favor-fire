    ...
    <div className="container mx-auto px-4 sm:px-6">
        <section className="text-center py-20 lg:py-32">
            ...
            <p className="text-lg text-foreground/80 max-w-3xl mx-auto mb-10">
                Kindred Connect é a sua plataforma comunitária para solicitar e oferecer ajuda, construindo laços mais fortes na sua vizinhança. Se precisa de uma mão ou quer estender a sua, este é o lugar.
            </p>
